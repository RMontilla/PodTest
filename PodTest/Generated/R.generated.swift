...
struct R: Rswift.Validatable {
  ...
  struct string {
    ...
    struct localizable {
      /// Base translation: Test String
      ///
      /// Locales: Base, en, ja
      static let testString = Rswift.StringResource(key: "test.string", tableName: "Localizable", bundle: R.hostingBundle, locales: ["Base", "en", "ja"], comment: nil)

      /// Base translation: Test String
      ///
      /// Locales: Base, en, ja
      static func testString(preferredLanguages: [String]? = nil) -> String {
        guard let preferredLanguages = preferredLanguages else {
          return NSLocalizedString("test.string", bundle: hostingBundle, value: "Test String", comment: "")
        }
        ...
        return NSLocalizedString("test.string", bundle: bundle, value: "Test String", comment: "")
      }
